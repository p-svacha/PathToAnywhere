...
public class Blendmap : MonoBehaviour
{
    ...
    public void BlendTile(MapGenerator generator, int x, int y, BaseSurfaceType type, TileSetSimple tileset)
    {
        ...
        neighbourTypes.Add(Direction.N, generator.GetTile(new Vector2Int(x, y - 1)).BaseSurfaceType);
        neighbourTypes.Add(Direction.NE, generator.GetTile(new Vector2Int(x - 1, y - 1)).BaseSurfaceType);
        neighbourTypes.Add(Direction.E, generator.GetTile(new Vector2Int(x - 1, y)).BaseSurfaceType);
        neighbourTypes.Add(Direction.SE, generator.GetTile(new Vector2Int(x - 1, y + 1)).BaseSurfaceType);
        neighbourTypes.Add(Direction.S, generator.GetTile(new Vector2Int(x, y + 1)).BaseSurfaceType);
        neighbourTypes.Add(Direction.SW, generator.GetTile(new Vector2Int(x + 1, y + 1)).BaseSurfaceType);
        neighbourTypes.Add(Direction.W, generator.GetTile(new Vector2Int(x + 1, y)).BaseSurfaceType);
        neighbourTypes.Add(Direction.NW, generator.GetTile(new Vector2Int(x + 1, y - 1)).BaseSurfaceType);
