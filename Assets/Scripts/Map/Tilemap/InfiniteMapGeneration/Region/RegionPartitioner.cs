...
namespace MapGeneration.Infinite
{
        ...
        private Dictionary<RegionType, int> RegionTable = new Dictionary<RegionType, int>()
    {
        ...
        public RegionPartitioner(InfiniteMapGenerator generator)
        {
        ...
        private void GenerateStartRegion()
        {
            ...
            Regions.Add(regionId, new Region_Grassland(MapGenerator, regionId));
        }
        ...
        private Region GetRandomRegion(Vector2Int id)
        {
            ...
            switch (type)
            {
                case RegionType.Grassland:
                    return new Region_Grassland(MapGenerator, id);
                case RegionType.Desert:
                    return new Region_Desert(MapGenerator, id);
                case RegionType.Mountain:
                    return new Regions_Mountains(MapGenerator, id);
                case RegionType.Ruins:
                    return new Region_Ruins(MapGenerator, id);
                case RegionType.Lake:
                    return new Region_Lake(MapGenerator, id);
                default:
