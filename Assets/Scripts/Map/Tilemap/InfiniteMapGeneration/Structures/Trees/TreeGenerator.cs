...
namespace MapGeneration.Infinite
{
    public class TreeGenerator : MonoBehaviour
    {
        ...
        private void Awake()
        {
            CypressTree1Base = TileGenerator.GetTileAt(CypressTree1, InfiniteMapGenerator.TilePixelSize, 0, 0);
            CypressTree1Mid = TileGenerator.GetTileAt(CypressTree1, InfiniteMapGenerator.TilePixelSize, 0, 1);
            CypressTree1Top = TileGenerator.GetTileAt(CypressTree1, InfiniteMapGenerator.TilePixelSize, 0, 2);
        }
